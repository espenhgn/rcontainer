...
options(BioC_mirror = "https://packagemanager.posit.co/bioconductor/2025-08-04")
options(BIOCONDUCTOR_CONFIG_FILE = "https://packagemanager.posit.co/bioconductor/2025-08-04/config.yaml")

# Configure a CRAN snapshot compatible with Bioconductor 3.22:
options(repos = c(CRAN = "https://packagemanager.posit.co/cran/__linux__/jammy/2025-08-04"))

# Bioconductor packages, comma delimited
packages <- c()
